...
These definitions are computed over the focused bridge case set in `/Users/jacobanderson/Documents/simulators/Cumulative Government Simulator/config/interbranch-bridge-v0.json`. They are alternative summaries of the same stress-profile results, not separate empirical validations.
